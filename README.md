...
In addition to the baseline system's artifact collection, the tool includes a persistence detection module that detects common Linux persistence mechanisms used by attackers, such as scheduled tasks, startup scripts, and more.
